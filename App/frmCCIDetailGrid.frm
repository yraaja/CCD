...
Begin VB.Form frmCCIDetailGrid 
   Caption         =   "CCI City Detail Grid"
   ClientHeight    =   6930
   ClientLeft      =   2265
   ClientTop       =   2835
   ClientWidth     =   11415
   Icon            =   "frmCCIDetailGrid.frx":0000
   LinkTopic       =   "Form1"
   MDIChild        =   -1  'True
   ScaleHeight     =   6930
   ScaleWidth      =   11415
   Begin VB.CommandButton cmdCreate 
      Caption         =   "&Create Detail Report"
      Height          =   495
      Left            =   9120
      TabIndex        =   32
      Top             =   6240
   ...
   End
End
Attribute VB_Name = "frmCCIDetailGrid"
...
Dim m_objGridMap As New CCCIDetailMap ' Class to handle grid
...
Private Sub cmdCreate_Click()
    ...
    If ExecStoredProcSelectedQuarter("sp_report_cci_detail_rpt") Then
        MsgBox "The Detail table has been updated.", vbInformation + vbOKOnly
    End If
...
'        GoTo Exit_Sub
    ...
    '    Screen.MousePointer = vbNormal
    '    MsgBox "The start quarter is required.", vbExclamation
    '    Exit Sub
    'End If
    ...
    Else
        sClassSystemID = "U2"
    End If
    strSELECT = "exec usp_select_published_cci_detail_rpt "
...
Public Sub PrintReport()
    ...
    If m_rec.RecordCount >= 1 Then
        fPreviewWindow.ReportName = "City Detail"
